...
CREATE MATERIALIZED VIEW customer_details AS
 SELECT customers.id AS customer_id,
   ...
   FROM ((((((customers
     ...
     JOIN addresses shipping_address ON ((shipping_address.id = customers_billing_addresses.address_id)))
...
INSERT INTO schema_migrations (version) VALUES ('20160310020934');

INSERT INTO schema_migrations (version) VALUES ('20160319211525');

INSERT INTO schema_migrations (version) VALUES ('20160324054419');

INSERT INTO schema_migrations (version) VALUES ('20160327152511');

INSERT INTO schema_migrations (version) VALUES ('20160501150341');

INSERT INTO schema_migrations (version) VALUES ('20160502102014');

INSERT INTO schema_migrations (version) VALUES ('20160504101541');
